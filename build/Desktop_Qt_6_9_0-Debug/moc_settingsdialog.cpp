...
template <> constexpr inline auto SettingsDialog::qt_create_metaobjectdata<qt_meta_tag_ZN14SettingsDialogE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        ...
        "settings",
        "on_btnApply_clicked",
        "on_btnSrvDir_clicked"
    };

    QtMocHelpers::UintData qt_methods {
        // Signal 'SettingsChanged'
        QtMocHelpers::SignalData<void(SettingsStruct)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
        // Slot 'on_btnApply_clicked'
        QtMocHelpers::SlotData<void()>(5, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_btnSrvDir_clicked'
...
void SettingsDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->SettingsChanged((*reinterpret_cast< std::add_pointer_t<SettingsStruct>>(_a[1]))); break;
        case 1: _t->on_btnApply_clicked(); break;
        case 2: _t->on_btnSrvDir_clicked(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (SettingsDialog::*)(SettingsStruct )>(_a, &SettingsDialog::SettingsChanged, 0))
            return;
    }
}
...
// SIGNAL 0
void SettingsDialog::SettingsChanged(SettingsStruct _t1)
{
